...
const FeatureCard = ({ icon: Icon, title, description, animationClass }) => (
  <div className={`group relative ${animationClass}`}>
    <div
      className="absolute -inset-1 bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl blur opacity-25 
    ...
    >
      <div
        className="absolute top-0 right-0 -mt-4 mr-4 w-20 h-20 bg-gradient-to-br from-indigo-600 to-purple-600 
                          rounded-full opacity-10 group-hover:opacity-20 transition-opacity duration-500"
      ></div>
      <PlaceholderIcon
        className="relative z-10 text-transparent bg-gradient-to-br from-indigo-600 to-purple-600 
  ...
  <div className="relative py-32 overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
      <div className="max-w-3xl mx-auto mb-16">
        <h2
          className="font-bold text-5xl bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 
                             bg-clip-text text-transparent mb-6 animate-gradient-x"
        >
          The AgileFlow Difference
        </h2>
        <p className="text-xl text-gray-700 leading-relaxed">
          Designed for speed and clarity. Focus on what matters with our core
          features.
        </p>
      </div>
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center md:flex md:items-center md:text-left">
            ...
            <div className="md:w-1/2 md:pr-12 animate-fadeInLeft">
              <div className="relative">
                <h1
                  className="font-lexend-deca font-black text-5xl md:text-7xl bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 
                ...
                <p className="font-lexend text-xl md:text-2xl text-gray-700 mb-8 leading-relaxed">
                  AgileFlow: Your collaborative hub for planning, tracking, and
                  managing tasks effortlessly.
                  <span className="block mt-2 text-primary-600 font-semibold">
                    Built for small, agile teams.
                  </span>
                </p>
                <div className="flex flex-col sm:flex-row justify-center md:justify-start space-y-4 sm:space-y-0 sm:space-x-4">
                  ...
                  >
                    ...
                    <div
                      className="absolute inset-0 h-full w-full bg-gradient-to-r from-indigo-600 to-purple-600 
            ...
            <div className="md:w-1/2 mt-12 md:mt-0 flex justify-center animate-fadeInRight">
              <div className="relative group">
                ...
                ></div>
                <div
                  className="relative bg-white rounded-2xl shadow-xl overflow-hidden transform transition duration-500 
